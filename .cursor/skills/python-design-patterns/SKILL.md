...
description: Python design patterns including KISS, Separation of Concerns, Single Responsibility, and composition over inheritance. Use when designing Python services or components, refactoring god classes, evaluating PR structure, separating I/O from business logic, or when the user invokes /python-patterns.
paths:
  - "**/*.py"
---
